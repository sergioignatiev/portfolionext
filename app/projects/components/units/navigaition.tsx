...
const NavigationUnits = () => {
  return (<>
 <div className="swiper-button-prev absolute top-[50%] z-10 lg:visible invisible">
  ...
  <path fill-rule="evenodd" clip-rule="evenodd" d="M15.5799 34.1318L0.961592 16.9299L15.548 0.616137L24.7212 0.965316L13.1231 14.098L43.0595 14.8829L42.8105 21.4251L12.7875 20.6376L24.7435 34.4806L15.5799 34.1318Z" fill="#E9E9E9"/>
      ...
      <div className="swiper-button-next absolute top-[50%] 2xl:right-[100px] right-[20px] z-10 lg:visible invisible"><svg xmlns="http://www.w3.org/2000/svg" width="43" height="35" viewBox="0 0 43 35" fill="none">
