...
let HoverUnit=({children,percentage}:{children:string,percentage:number})=>{
    return <div className="text-white flex items-center justify-center  group  pt-[20px] w-full ">
    <p className="mr-[20px] 2xl:text-[16px] text-[12px] w-[45%]">{children}</p>
<div className=" w-[55%]">
...
<div className="w-[100%] bg-[#333333] 2xl:h-[27px] h-[17px] rounded-[21px] text-right pr-[2px] pt-[3px]">100%</div>
...
const Hovers = ({hovers}:{hovers?:H[]}) => {
  return (
    <div className="ml-[20px] duration-100 delay-100   w-[700px] h-[0px] group-hover:h-[100%]   [transform:rotateX(90deg)] group-hover:[transform:rotateX(0deg)]">
        <div className="ml-[20px] border-[#D9D9D9] border-[1px] 2xl:p-[30px] p-[10px] rounded-[21px]">
